...
class TutorialFragment2 : Fragment()
{
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View?
    {
        ...
        initialise(view)  // function for initialising the variables and views of the class
    ...
    private fun initialise(view: View?)
    {
        ...
        tvTextHeading.text = resources.getString(R.string.ods)

        tvTextFullForm = view.findViewById(R.id.tvTextFullForm)

        tvTextFullForm.text = resources.getString(R.string.ods_fullform)

        tvText = view.findViewById(R.id.tvText)

        tvText.text = resources.getString(R.string.ods_tutorial_text)
    }
    ...
    // initialising the  startGif Broadcast Receiver
    private val startGif = object : BroadcastReceiver()
    {
        override fun onReceive(context: Context, intent: Intent)
        {
            ...
            activity!!.runOnUiThread {
                if (position == 1)
                    gif.postDelayed({ gif.setBackgroundResource(R.drawable.secondgif) }, 500)
            }
        }
    }
}